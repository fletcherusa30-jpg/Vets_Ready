...
export const FinancePage: React.FC = () => {
  return (
    <div className="vetsready-finance">
      <section className="bg-gradient-to-r from-emerald-900 to-emerald-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl font-bold mb-4">Vets Ready Finance & Retirement</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="mt-16 bg-emerald-50 rounded-lg p-8">
          ...
          <p className="text-gray-600 mb-6">Vets Ready helps you understand how these income sources work together:</p>
