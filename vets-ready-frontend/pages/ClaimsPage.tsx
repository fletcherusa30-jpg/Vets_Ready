...
export const ClaimsPage: React.FC = () => {
  return (
    <div className="vetsready-claims">
      <section className="bg-gradient-to-r from-orange-900 to-orange-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl font-bold mb-4">Vets Ready Claims Readiness</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-8">
          ...
          <p className="text-gray-700">
            Vets Ready provides education and preparation tools only. We do not:
          </p>
