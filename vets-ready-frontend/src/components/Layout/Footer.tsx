      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p className="footer-text">
            Vets Ready is an <strong>educational and organizational tool</strong> only.
        ...
        <div className="footer-bottom">
          <p className="copyright">© 2026 Vets Ready • Educational Tool Only • Not Government Affiliated</p>
        </div>
      </div>
