    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-700 mt-2">Manage your VetsReady subscription and payment methods</p>
        </div>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border-2 border-gray-300 rounded-lg p-6">
          ...
          <p className="text-gray-600 mb-6">Perfect for getting started and exploring VetsReady</p>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">Manage your payment methods for VetsReady Premium</p>
      </div>
