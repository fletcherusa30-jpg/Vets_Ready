        ...
        {activeSection === 'appeals' && (
          <div className="section">
            ...
            <div className="appeals-disclaimer">
              ...
              <p>VetsReady provides <strong>educational information only</strong>. We do NOT:</p>
              <ul>
            ...
            <div className="summary-overview">
              ...
              <div className="va-redirect-section">
                ...
                <p className="disclaimer">
                  <strong>Important:</strong> VetsReady does not file claims. We prepare and educate only.
