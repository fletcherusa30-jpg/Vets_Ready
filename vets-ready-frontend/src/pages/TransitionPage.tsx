    ...
    <div className="transition-page" style={{ maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{ color: '#4a5568', lineHeight: 1.6, marginBottom: '1rem' }}>
            VetsReady provides <strong>educational transition planning resources only</strong>. We do not provide legal advice, career counseling, or official transition services.
          </p>
          <p style={{ color: '#4a5568', lineHeight: 1.6 }}>
