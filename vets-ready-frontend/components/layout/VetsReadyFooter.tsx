...
export const VetsReadyFooter: React.FC = () => {
  return (
    <footer className="vetsready-footer bg-gray-900 text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="font-bold mb-4">Vets Ready</h3>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Vets Ready. All rights reserved. Built to honor the service of US military veterans.
          </p>
