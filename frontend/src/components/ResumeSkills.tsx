...
export const MOS_SKILLS: Record<string, string[]> = {
  ...
  '3D1X2_TRANSPORT': ['Cyber transport systems', 'Network configuration', 'Troubleshooting', 'Cable installation', 'Equipment maintenance', 'Documentation', 'Security procedures', 'User support', 'Quality control', 'Team coordination'],
  ...
  'USCG_BM': ['Boatswain\'s mate', 'Boat operations', 'Navigation', 'Search and rescue', 'Maritime law enforcement', 'Seamanship', 'Damage control', 'Leadership', 'Safety compliance', 'Emergency response'],
  'USCG_DC': ['Damage controlman', 'Damage control', 'Firefighting', 'Emergency response', 'Equipment maintenance', 'Training', 'Safety procedures', 'CBRN defense', 'Documentation', 'Team leadership'],
  'USCG_EM': ['Electrician\'s mate', 'Electrical systems', 'Power generation', 'Troubleshooting', 'Maintenance', 'Safety procedures', 'Blueprint reading', 'Quality control', 'Documentation', 'Team coordination'],
  'USCG_ET': ['Electronics technician', 'Electronics systems', 'Radar', 'Navigation systems', 'Communications', 'Troubleshooting', 'Repair procedures', 'Technical manuals', 'Documentation', 'Quality control'],
  'USCG_FS': ['Food service specialist', 'Food preparation', 'Menu planning', 'Sanitation', 'Nutrition', 'Inventory management', 'Food safety', 'Customer service', 'Leadership', 'Team coordination'],
  'USCG_HS': ['Health services technician', 'Patient care', 'Medical procedures', 'Emergency response', 'Medical documentation', 'Pharmacy operations', 'Patient education', 'Clinical skills', 'Team collaboration', 'Health promotion'],
  'USCG_IS': ['Intelligence specialist', 'Intelligence analysis', 'Data collection', 'Briefing preparation', 'Database management', 'Research', 'Reporting', 'Security procedures', 'Presentation skills', 'Critical thinking'],
  'USCG_IT': ['Information systems technician', 'Network administration', 'Computer systems', 'Troubleshooting', 'Security procedures', 'User support', 'Documentation', 'Software installation', 'Hardware maintenance', 'Quality control'],
  'USCG_ME': ['Maritime enforcement specialist', 'Law enforcement', 'Boarding operations', 'Investigations', 'Use of force', 'Maritime law', 'Physical fitness', 'Report writing', 'Team coordination', 'Emergency response'],
  'USCG_MK': ['Machinery technician', 'Engine maintenance', 'Troubleshooting', 'Repair procedures', 'Preventive maintenance', 'Technical manuals', 'Quality control', 'Safety procedures', 'Documentation', 'Team coordination'],
  'USCG_MST': ['Marine science technician', 'Environmental protection', 'Pollution response', 'Inspections', 'Investigations', 'Data collection', 'Technical procedures', 'Reporting', 'Safety procedures', 'Team coordination'],
  'USCG_OS': ['Operations specialist', 'Radar operations', 'Communications', 'Navigation', 'Search and rescue coordination', 'Watchstanding', 'Data analysis', 'Multi-tasking', 'Team coordination', 'Emergency procedures'],
  'USCG_PA': ['Public affairs specialist', 'Media relations', 'Photography', 'Videography', 'Journalism', 'Public speaking', 'Social media', 'Communication', 'Creative design', 'Event planning'],
  'USCG_SK': ['Storekeeper', 'Supply chain management', 'Inventory control', 'Procurement', 'Documentation', 'Customer service', 'Data entry', 'Warehouse operations', 'Quality control', 'Organization'],
  'USCG_YN': ['Yeoman', 'Office administration', 'Correspondence', 'Record keeping', 'Data entry', 'Customer service', 'Regulations compliance', 'Communication', 'Organizational skills', 'Computer skills'],
