...
<body>
  <h1>rallyforge Claim Preparation Summary</h1>
  ...
  <div class="section">
    <p><strong>Disclaimer:</strong> This is an educational tool only. rallyforge does not file claims. Submit your claim at <a href="https://www.va.gov">VA.gov</a>.</p>
  </div>
</body>
</html>
    `;
    ...
    a.href = url;
    a.download = 'rallyforge_Claim_Summary.html';
    a.click();
  };
