...
export const JobsBusinessPage: React.FC = () => {
  return (
    <div className="rallyforge-jobs-business">
      <section className="bg-gradient-to-r from-cyan-900 to-cyan-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl font-bold mb-4">Rally Forge Jobs & Business</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="mt-16 bg-cyan-50 rounded-lg p-8">
          <h3 className="text-2xl font-bold mb-6 text-cyan-900">Why Post on Rally Forge?</h3>
