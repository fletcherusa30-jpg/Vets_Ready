...
const AppContent: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className="min-h-screen relative va-theme-bg"
      >
        ...
        <div className="relative z-10">
          ...
          <header
            className="text-white py-8 shadow-2xl border-b-4 va-theme-bg va-theme-border"
          >
            <div className="container mx-auto px-4">
              <div className="flex items-center justify-between">
                <Link to="/" className="hover:opacity-90 transition-opacity">
                  <div className="flex items-center">
                    <div className="flex flex-col items-center sm:items-start pr-4 sm:pr-6 min-w-[330px]">
                      <img
                        src="/rally-forge-logo.png"
                        alt="Rally Forge Logo"
                        className="h-32 md:h-40 lg:h-44 w-auto max-w-[460px] object-contain drop-shadow-[0_12px_28px_rgba(0,0,0,0.75)] brightness-110 contrast-125"
                      />
                      <p className="mt-3 md:mt-4 text-base md:text-lg font-bold uppercase tracking-wider text-white whitespace-nowrap drop-shadow-[0_3px_8px_rgba(0,0,0,0.7)]">
                        We got your six
                      </p>
                    </div>
                  </div>
                </Link>
                <nav className="hidden md:flex gap-6 lg:gap-7 items-center">
                  <Link
                    to="/claims"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center md:text-left">
                  <div className="flex items-center gap-3 justify-center md:justify-start mb-3">
                    <div>
                      <h3 className="text-2xl font-bold va-theme-text">Rally Forge</h3>
                    </div>
                  </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm mt-4 opacity-70 va-theme-text">
                    © {new Date().getFullYear()} Rally Forge. All rights reserved.
                  </p>
                </div>
