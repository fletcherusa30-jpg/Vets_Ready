/**
 * Home Page - Entry Point for Rally Forge Platform
 *
 * Purpose:
 * - Introduce the platform clearly and simply
 * - Explain what Rally Forge does in plain language
  ...
  return (
    <div className="home-page">
      ...
      <section className="features-section">
        <h2 className="section-title">What Rally Forge Does for You</h2>
      ...
      {/* FOOTER DISCLAIMERS */}
      <section className="disclaimers-section camo-footer">
        <div className="disclaimer-card">
          <h3>⚠️ Important Notice</h3>
          <p>
            <strong>Rally Forge is NOT affiliated with the Department of Veterans Affairs or any government agency.</strong>
          </p>
          <p>
      ...
      <style>{`
        ...
        .va-link:hover {
          background: #556b2f;
          box-shadow: 0 4px 12px rgba(45, 63, 31, 0.4);
          transform: translateY(-2px);
        }
