...
class VeteranSubscription(Base):
    ...
    __tablename__ = "rallyforge_veteran_subscriptions"

    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    user_id = Column(UUID(as_uuid=True), ForeignKey("rallyforge_users.id"), nullable=False)
...
class EmployerAccount(Base):
    ...
    __tablename__ = "rallyforge_employer_accounts"
...
class BusinessListing(Base):
    ...
    __tablename__ = "rallyforge_business_listings"
...
class JobPost(Base):
    ...
    __tablename__ = "rallyforge_job_posts"

    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    employer_id = Column(UUID(as_uuid=True), ForeignKey("rallyforge_employer_accounts.id"), nullable=False)
...
class Lead(Base):
    ...
    __tablename__ = "rallyforge_leads"

    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)

    # Lead info
    veteran_user_id = Column(UUID(as_uuid=True), ForeignKey("rallyforge_users.id"), nullable=False)
...
class Invoice(Base):
    ...
    __tablename__ = "rallyforge_invoices"

    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)

    # Customer (can be employer or business)
    employer_id = Column(UUID(as_uuid=True), ForeignKey("rallyforge_employer_accounts.id"), nullable=True)
    business_id = Column(UUID(as_uuid=True), ForeignKey("rallyforge_business_listings.id"), nullable=True)
...
class VSOPartner(Base):
    ...
    __tablename__ = "rallyforge_vso_partners"
