...
async def stripe_webhook(
    ...
    try:
        ...
        # - Update subscription status in vetsready_veteran_subscriptions
        # - Update employer_accounts subscription status
        # - Create payment records in vetsready_payments
        # - Update invoice status in vetsready_invoices
...
async def create_checkout_session(request: Request):
    ...
    {
        "price_id": "price_xxx",
        "success_url": "https://app.vetsready.com/success",
        "cancel_url": "https://app.vetsready.com/cancel",
